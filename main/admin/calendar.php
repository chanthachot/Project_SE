            ...
            <div class="top-menu bg-passtell">
                <div class="container">
                    ...
                    <ul>
                            ...
                            <li class="active"><a href="calendar.php"><i class="fas fa-calendar-day"></i> ตารางเวลา</a></li>
        ...
        <div id="calendar_bg">
            <div class="container">
				...
				foreach ($president as $row => $president) {
					echo  '<option value="' . $president['presidentid'] . '">' . $president['presidentname'] . '</option>';
				}
				?>
                            </select>
                            <br>
